    ...
    <script>
        ...
        window.addEventListener("message", function(event) {
            ...
            if (receivedMessage.name === 'Open') {
                ...
                let settings = ajax_settings("{{Config::get("Global")['ukassa']}}"+'widget/InfoAttributes/', 'GET', data)
                console.log('widget setting attributes: ↓')
                console.log(settings)

                $.ajax(settings).done(function (response) {
                    console.log("{{Config::get("Global")['ukassa']}}" + 'widget/InfoAttributes/ response ↓ ')
                    console.log(settings)
        ...
        <div class="row gradient rounded p-2">
            <div class="col-4 ">
                <div class="mx-2"> <img src="https://ukassa.kz/_nuxt/img/d2b49fb.svg" width="100%"   alt=""> </div>
            </div>
            <div class="col-8 ">
